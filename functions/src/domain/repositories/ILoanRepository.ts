...
export interface ILoanRepository {
    ...
    /**
     * Get all loans for a specific person (by userId and personId)
     */
    getByPerson(userId: string, personId: string): Promise<Loan[]>;

    /**
     * Get all loans for a specific person (alias for getByPerson)
     */
    getByPersonId(userId: string, personId: string): Promise<Loan[]>;
